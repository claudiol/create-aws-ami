...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.create-aws-ami.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".create-aws-ami" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".create-aws-ami")
	}
